"""
Production settings for demo project.
...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['demo.com', ])
...
DEFAULT_FROM_EMAIL = env('DJANGO_DEFAULT_FROM_EMAIL',
                         default='demo <noreply@demo.com>')
EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[demo]')
